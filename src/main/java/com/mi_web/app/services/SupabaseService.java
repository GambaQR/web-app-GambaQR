...
public class SupabaseService {
    ...
    private final String SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRpZ3NreWR2d3dxbGZ5cGZ3eXlxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDc3Mzc0MTQsImV4cCI6MjA2MzMxMzQxNH0.WRprX6IA1PGc-7E_8mr6ANHyPsuVbZZuivVL_7Mrh5Q"; // Clave
                                                                                                                                                                                                                                                                 // anon
                                                                                                                                                                                                                                                                 // del
                                                                                                                                                                                                                                                                 // proyecto
    ...
    public String uploadImage(MultipartFile file) throws Exception {
        ...
        String uniqueFileName = UUID.randomUUID().toString() + "_" + originalFileName; // Agregar UUID al nombre
                                                                                       // original
        ...
        if (response.getStatusCode() == HttpStatus.OK) {
            ...
            if (responseBody.has("Key")) {
                ...
                String fileUrl = SUPABASE_URL + "/storage/v1/object/public/" + bucketName + "/" + fileKey;
